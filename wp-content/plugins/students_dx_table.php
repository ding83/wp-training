<?php
/**
 * Plugin Name: Students Table
 * Description: List students table
 * Plugin URI: none
 * Author: dev test
 * Author URI: none
 * Version: 1.0
...
class Student_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$args = array('post_type' => 'students', 'post_status' => 'publish', 'posts_per_page' => -1);
		...
		while ( $loop->have_posts() ) : $loop->the_post();
			$this->student_data[] = array(
				...
				'year' => get_post_meta(get_the_ID(), '_studentYear', true),
				'section' => get_post_meta(get_the_ID(), '_studentSection', true),
				'address' => get_post_meta(get_the_ID(), '_studentAddress', true),
